            ...
            <div className="flex items-center">
              <Link href={"/"}>
                <div className="ml-10 flex items-center select-none cursor-pointer">
                  {/* <img src={"/images/appLogo.png"} className="w-11" alt="" /> */}
                  <h3 className="text-base text-gray-800 font-semibold tracking-normal leading-tight mr-3 hidden lg:block">
                    بطاقاتي
                  </h3>
                </div>
              </Link>
        ...
        <nav>
          {!show ? (
            <div className="border py-4 px-6 w-full flex xl:hidden justify-between items-center bg-white  top-0 z-0">
              <div className="w-24">
                <img src={"/images/appLogo.png"} className="w-10" alt="" />
              </div>
              <div>
                <div
                  id="menu"
          ...
          <div
            className={
              show
                ? "shadow w-full h-full absolute z-40 xl:hidden transform  translate-x-0 "
                : " shadow  w-full h-full absolute z-40 xl:hidden transform -translate-x-full"
            }
          >
            <div
                      ...
                      <div className="flex items-center justify-between w-full ">
                        <div className="flex items-center select-none cursor-pointer">
                          <img
                            ...
                            alt=""
                          />
                          <h3 className="text-base tracking-normal leading-tight mr-3">
                            بطاقاتي
                          </h3>
                        </div>
                        <div
